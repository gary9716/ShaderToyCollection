// Shader downloaded from https://www.shadertoy.com/view/4dXGRM
// written by shadertoy user kataho
//
// Name: flying steel cubes
// Description: Cubes got light, texture and translation.
//    Kill fov morphing if you want less psychedelic.
